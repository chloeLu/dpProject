...
import cs5248.dash.video.VideoInfo.VideoInfoItem;
...
public class VideoDetailFragment extends Fragment {
    ...
    final Queue<StreamletInfo> readySegments = new ArrayDeque<StreamletInfo>();
    StreamletInfo activeSegment = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
        	SparseArray<VideoInfoItem> items = VideoInfo.ITEM_MAP;
        	int item_id = getArguments().getInt(ARG_ITEM_ID);
            mItem = items.get(item_id);
        }
    }
    ...
    private void prepareNextPlayer(final StreamletInfo segment) {
	...
	public synchronized void queueForPlayback(final StreamletInfo segment) {
